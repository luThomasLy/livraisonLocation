...
// --------------------------------------------------------------------------
    public String toString()
    {
        ...
        retour = "id livreur              : " + idLivreur + "\n";
        retour += "nom livreur                 : " + nomLivreur + "\n";
        retour += "prenom livreur                 : " + prenomLivreur + "\n";
        retour += "num permis livreur             : " + numPermisLivreur + "\n";
        retour += "adresse livreur         : " + adresseLivreur + "\n";
        retour += "code postal livreur               : " + codePostalLivreur + "\n";
        retour += "ville livreur        : " + villeLivreur + "\n";
